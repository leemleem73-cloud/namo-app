(function qmesEquipmentDailyStatusCards(){
  ...
  function ensureStyle(){
    ...
    style.textContent=`
      ...
      html body .qmes-ipad-equipment .qmes-equipment-tour-status-row.qmes-daily-guide-only{display:flex!important;align-items:center!important;min-height:50px!important;padding:0 14px!important;border:1px solid #d7e0e8!important;border-radius:10px!important;background:#fff!important;box-sizing:border-box!important;}
      html body .qmes-ipad-equipment .qmes-equipment-tour-status-row.qmes-daily-guide-only>.qmes-equipment-tour-status-actions,
      html body .qmes-ipad-equipment .qmes-equipment-tour-status-row.qmes-daily-guide-only>.qmes-equipment-tour-statuses{display:none!important;}
      html body .qmes-ipad-equipment .qmes-equipment-tour-status-row.qmes-daily-guide-only .qmes-equipment-tour-guide-text{font-size:10px!important;line-height:1.2!important;white-space:nowrap!important;overflow:visible!important;color:#475569!important;-webkit-text-fill-color:#475569!important;}
