(function qmesEquipmentDailyStatusCards(){
  ...
  function ensureStyle(){
    ...
    style.textContent=`
      html body .qmes-ipad-equipment .${WRAP_CLASS}{font-family:Pretendard,"Pretendard Variable","Noto Sans KR",system-ui,sans-serif!important;display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:10px!important;margin:0!important;width:100%!important;}
      html body .qmes-ipad-equipment .qmes-daily-status-card{display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:0!important;min-height:82px!important;padding:11px 14px!important;border:1px solid #d9e2ec!important;border-radius:10px!important;background:#fff!important;background-color:#fff!important;box-sizing:border-box!important;box-shadow:0 2px 7px rgba(15,23,42,.05)!important;text-align:center!important;overflow:hidden!important;}
