/* QMES FIXED CALENDAR - NATIVE STYLE V7 MOVE RESIZE - 2026-09-22
...
(function(){
  "use strict";
  if(window.__QMES_FIXED_CALENDAR_NATIVE_STYLE_20260922_V7__) return;
  window.__QMES_FIXED_CALENDAR_NATIVE_STYLE_20260922_V7__=true;
  ...
  let mode="days";
  let yearPageStart=0;
  const WINDOW_KEY="qmes-sales-calendar-window-v7";
  ...
  function ensureStyle(){
    ...
    mini.textContent=`
      #${POP_ID}{width:220px!important;min-width:220px!important;max-width:220px!important}
