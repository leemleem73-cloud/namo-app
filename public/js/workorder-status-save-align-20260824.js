...
(function(){
  ...
  style.textContent=`
    ...
    .qmes-issued-table-v2 th:nth-child(10),.qmes-issued-table-v2 td:nth-child(10){
      width:5%!important;min-width:0!important;max-width:none!important;
    ...
    .qmes-issued-table-v2 td:nth-child(10) .qmes-status-select{
      ...
      width:56px!important;min-width:52px!important;max-width:56px!important;
      height:24px!important;min-height:24px!important;max-height:24px!important;
      margin:0 auto!important;padding:0 13px 0 3px!important;font-size:8px!important;line-height:26px!important;text-align:center!important;
      flex:none!important;
    }
  `;
