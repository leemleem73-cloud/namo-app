/* QMES FIXED CALENDAR - NATIVE STYLE V9 ULTRA MINI MOVE RESIZE - 2026-09-22
...
(function(){
  "use strict";
  if(window.__QMES_FIXED_CALENDAR_NATIVE_STYLE_20260922_V9__) return;
  window.__QMES_FIXED_CALENDAR_NATIVE_STYLE_20260922_V9__=true;
  ...
  let mode="days";
  let yearPageStart=0;
  const WINDOW_KEY="qmes-sales-calendar-window-v9";
  ...
  function ensureStyle(){
    ...
    ultraMini.id="qmes-fixed-calendar-ultra-mini-v9-style";
