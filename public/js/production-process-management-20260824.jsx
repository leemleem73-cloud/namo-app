  ...
  return (
    <div className="qmes-prod-process">
      <style>{`
        ...
        @media(max-width:1100px){.qpp-info{grid-template-columns:repeat(3,1fr)}.qpp-actionbar{grid-template-columns:repeat(3,1fr)}}@media(max-width:700px){.qpp-head{align-items:flex-start;flex-direction:column}.qpp-toolbar{width:100%;flex-wrap:wrap}.qpp-select{width:100%;min-width:0}.qpp-info{grid-template-columns:repeat(2,1fr)}.qpp-worker{align-items:flex-start;flex-direction:column}.qpp-actionbar{grid-template-columns:repeat(2,1fr)}.qpp-workers{grid-template-columns:repeat(2,1fr)}.qpp-form{grid-template-columns:1fr}.qpp-side{grid-template-columns:1fr}.qpp-table th{font-size:11px;padding:9px 3px}.qpp-table td{font-size:11px;padding:11px 3px}.qpp-status{min-width:0;padding:5px 4px;font-size:10px}}
      `}</style>
