...
(function(){
  "use strict";
  if(window.__QMES_SALES_REACT_LEDGER_OWNER_V6_20260918__) return;
  window.__QMES_SALES_REACT_LEDGER_OWNER_V6_20260918__=true;
  ...
  function StableSalesLedgerV6(){
    ...
    const rowNodes=shown.length?shown.map((x,i)=>h("tr",{key:x.id},\n      h("td",{className:"qslv6-no"},String((activePage-1)*PAGE_SIZE+i+1)),
      ...
      h("td",{className:"qty-center"},fmt(x.qty)),
      h("td",null,x.unit),
      h("td",null,x.due||"-"),
    ...
    return h("div",{className:"qmes-sales-ledger-v6"},
  ...
  window.QMESErpSalesTab=StableSalesLedgerV6;
