...
function AttendancePanel({currentUser,users}){
  ...
  return <div style={{flex:1,minHeight:0,overflow:"auto",padding:14,background:"#f8fafc",position:"relative"}}>
    ...
    <div style={{fontSize:compact?16:18,fontWeight:900}}>근태관리</div><div style={{fontSize:compact?10:11,color:"#64748b",marginTop:3}}>{currentUser.name} · {currentUser.dept||"부서 미지정"}</div>
