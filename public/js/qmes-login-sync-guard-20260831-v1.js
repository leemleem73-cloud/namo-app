...
(function installQmesLoginSyncCoordinator(global){
  ...
  const QUALITY_UI_SRC="./js/qmes-quality-inspection-ui-20260901.js?v=20260901-quality18-smooth-scroll";
  ...
  function loadQualityInspectionUi(){
    ...
    if(current&&String(current.src||"").includes("quality18-smooth-scroll")) return;
