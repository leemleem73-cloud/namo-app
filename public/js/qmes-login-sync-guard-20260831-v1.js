...
(function installQmesLoginSyncCoordinator(global){
  ...
  const QUALITY_UI_SRC="./js/qmes-quality-inspection-ui-20260901.js?v=20260901-quality17-overlay-scroll";
  ...
  function loadQualityInspectionUi(){
    ...
    if(current&&String(current.src||"").includes("quality17-overlay-scroll")) return;
