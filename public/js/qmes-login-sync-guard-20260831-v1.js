...
(function installQmesLoginSyncCoordinator(global){
  ...
  const QUALITY_UI_SRC="./js/qmes-quality-inspection-ui-20260901.js?v=20260901-quality19-wheel-viewer-head";
  ...
  function loadQualityInspectionUi(){
    ...
    if(current&&String(current.src||"").includes("quality19-wheel-viewer-head")) return;
