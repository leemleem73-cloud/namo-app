...
(function installQmesLoginSyncCoordinator(global){
  ...
  const QUALITY_UI_SRC="./js/qmes-quality-inspection-ui-20260901.js?v=20260901-quality21-output-below-header";
  ...
  function loadQualityInspectionUi(){
    ...
    if(current&&String(current.src||"").includes("quality21-output-below-header")) return;
