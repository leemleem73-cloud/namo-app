...
(function(){
  "use strict";
  if(window.__QMES_SALES_REACT_LEDGER_OWNER_V5_20260918__) return;
  window.__QMES_SALES_REACT_LEDGER_OWNER_V5_20260918__=true;
  ...
  function StableSalesLedgerV5(){
    ...
    const rowNodes=shown.length?shown.map(x=>h("tr",{key:x.id},
    ...
    )):[h("tr",{key:"empty"},h("td",{colSpan:11,className:"qrl-empty"},"조회 조건에 해당하는 수주가 없습니다."))];
        ...
        h("div",{className:"qrl-wrap"},
          h("table",null,
            h("thead",null,h("tr",null,
              ["수주일 ↓","수주번호","거래처명","품목명 (규격)","수주수량","단위","요청납기","납기상태","생산상태","출하상태","관리"].map(v=>h("th",{key:v},v))
            )),
  ...
  window.QMESErpSalesTab=StableSalesLedgerV5;
