...
@media print{
  ...
  body.qmes-cert-print-live .qmes-cert-print-path{
    ...
    transform:none!important;float:none!important;max-width:none!important;min-width:0!important;
    height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important;
  }

  body.qmes-cert-print-live .qmes-cert-print-target{
    position:static!important;left:auto!important;right:auto!important;top:auto!important;bottom:auto!important;
    float:none!important;clear:both!important;margin-left:auto!important;margin-right:auto!important;
  ...
  body.qmes-cert-print-pqc #root,
  body.qmes-cert-print-iqc #root>div,
  body.qmes-cert-print-pqc #root>div,
  body.qmes-cert-print-iqc #root>div>main,
  body.qmes-cert-print-pqc #root>div>main,
  body.qmes-cert-print-iqc .qmes-cert-print-path:not(.qmes-cert-print-target),
  body.qmes-cert-print-pqc .qmes-cert-print-path:not(.qmes-cert-print-target){
  ...
  body.qmes-cert-print-iqc .qmes-cert-print-path:not(.qmes-cert-print-target)::before,
  body.qmes-cert-print-iqc .qmes-cert-print-path:not(.qmes-cert-print-target)::after,
  body.qmes-cert-print-pqc .qmes-cert-print-path:not(.qmes-cert-print-target)::before,
  body.qmes-cert-print-pqc .qmes-cert-print-path:not(.qmes-cert-print-target)::after{
  ...
  body.qmes-cert-print-iqc .qmes-cert-print-iqc-stage{
    ...
    display:flex!important;align-items:center!important;justify-content:center!important;box-sizing:border-box!important;background:#fff!important;
  }
