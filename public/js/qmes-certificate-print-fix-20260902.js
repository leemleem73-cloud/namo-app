...
(function(global){
'use strict';
if(global.__QMES_CERT_PRINT_V18__)return;global.__QMES_CERT_PRINT_V18__=true;
var id='qmes-cert-print-v18',sel='.qmes-iqc-doc:not(.qmes-wo-cert),.qmes-pqc-doc,.qmes-oqc-doc',target=null;
...
html body #root .qmes-oqc-doc .qmes-iqc-centered-title{transform:translateY(-24px)!important;}
@media print{
...
/* OQC: title text only, do not move logo/table/body. */
body.qmes-cert-print-oqc .qmes-cert-print-target .qmes-iqc-centered-title{transform:translateY(-24px)!important;}
