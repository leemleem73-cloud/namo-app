...
(function(global){
'use strict';
if(global.__QMES_CERT_PRINT_V20__)return;global.__QMES_CERT_PRINT_V20__=true;
var id='qmes-cert-print-v20',sel='.qmes-iqc-doc:not(.qmes-wo-cert),.qmes-pqc-doc,.qmes-oqc-doc',target=null;
...
/* OQC title: use positional movement instead of transform so older transform rules cannot cancel it. */
html body #root .qmes-oqc-doc .qmes-iqc-centered-title{position:relative!important;top:-55px!important;transform:none!important;z-index:5!important;}
@media print{
...
body.qmes-cert-print-oqc .qmes-cert-print-target .qmes-iqc-centered-title{position:relative!important;top:-55px!important;transform:none!important;z-index:5!important;}
