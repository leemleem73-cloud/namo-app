...
(function(global){
'use strict';
if(global.__QMES_CERT_PRINT_V16__)return;global.__QMES_CERT_PRINT_V16__=true;
var id='qmes-cert-print-v16',sel='.qmes-iqc-doc:not(.qmes-wo-cert),.qmes-pqc-doc,.qmes-oqc-doc',target=null;
...
body.qmes-cert-print-iqc,body.qmes-cert-print-pqc,body.qmes-cert-print-iqc #root,body.qmes-cert-print-pqc #root,body.qmes-cert-print-iqc #root>div,body.qmes-cert-print-pqc #root>div,body.qmes-cert-print-iqc #root>div>main,body.qmes-cert-print-pqc #root>div>main{background:#fff!important;background-image:none!important;box-shadow:none!important;}
...
/* PQC: move the complete certificate as one block: logo, title, text, borders and tables. */
