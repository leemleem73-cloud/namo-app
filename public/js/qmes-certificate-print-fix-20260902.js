...
(function(global){
'use strict';
if(global.__QMES_CERT_PRINT_V17__)return;global.__QMES_CERT_PRINT_V17__=true;
var id='qmes-cert-print-v17',sel='.qmes-iqc-doc:not(.qmes-wo-cert),.qmes-pqc-doc,.qmes-oqc-doc',target=null;
...
html body #root .qmes-oqc-doc .qmes-iqc-centered-title{transform:translateY(-16px)!important;}
@media print{
...
/* Print wrappers must stay pure white. Keep intended fills inside the certificate itself. */
...
body.qmes-cert-print-oqc .qmes-cert-print-target .qmes-iqc-centered-title{transform:translateY(-16px)!important;}
