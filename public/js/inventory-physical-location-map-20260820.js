/* QMES inventory physical rack master and safe location selection helpers. */
(function installInventoryPhysicalLocationMap(global){
  "use strict";
  if(global.qmesInventoryPhysicalLocations) return;
  ...
  const RAW_RULES=[
    ...
    {id:"SBS",test:(value)=>value.includes("SBS"),locations:["A-1-2","A-1-1"]},
    ...
    {id:"AOH30",test:(value)=>value.includes("AOH30"),locations:["A-4-1","A-4-2"]},
  ...
  global.qmesInventoryPhysicalLocations={
