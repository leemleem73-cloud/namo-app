...
(function(){
  "use strict";
  if(window.__QMES_SALES_REACT_LEDGER_OWNER_V3_20260918__) return;
  window.__QMES_SALES_REACT_LEDGER_OWNER_V3_20260918__=true;
  ...
  function install(){
    if(window.QMESErpSalesTab===StableSalesLedger) return;
