...
(function installQmesQualityInspectionUi(global){
  "use strict";
  if(global.__QMES_QUALITY_INSPECTION_UI_20260901_V13__) return;
  global.__QMES_QUALITY_INSPECTION_UI_20260901_V13__=true;

  const STYLE_ID="qmes-quality-inspection-ui-style-20260901-v13";
  ...
  function ensureStyle(){
    ...
    style.textContent=`
      ...
      /* Registration layer stays above the fixed QMES header/menu. */
      ...
      /* Remove remaining gray/slate surfaces inside IQC/PQC/OQC registration only. */
  ...
  function printRegistrationModal(){
    ...
    global.setTimeout(()=>{
      try{global.print();}finally{global.setTimeout(cleanup,300);}
    },0);
  }
  ...
  function enhanceModalHead(head){
    ...
    printBtn.className="qmes-quality-modal-print";
    printBtn.textContent="인쇄";
    printBtn.setAttribute("aria-label","신규등록 화면 인쇄");
    printBtn.addEventListener("click",printRegistrationModal);
