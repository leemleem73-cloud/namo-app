  ...
  function EquipmentManagementTab(props){
    ...
    return <div className="qmes-equipment-management-layout">
      ...
      <main className="qmes-equipment-management-content">
        ...
        {section==="repair"&&<div className="qmes-equipment-history-screen qmes-equipment-repair-screen">
          <Panel title="고장·수리 이력" right={<button type="button" onClick={()=>setShowRepairForm(value=>!value)} className={`${smallButton} qmes-equipment-new-register border-slate-700 bg-white text-slate-900`}>{showRepairForm?"등록 닫기":"신규 등록"}</button>}>
            ...
            <div className="qmes-equipment-table-wrap">
              <table className="qmes-equipment-unified-table qmes-equipment-repair-table">
                <colgroup><col style={{width:"18%"}}/><col style={{width:"12%"}}/><col style={{width:"20%"}}/><col style={{width:"20%"}}/><col style={{width:"12%"}}/><col style={{width:"9%"}}/><col style={{width:"9%"}}/></colgroup>
