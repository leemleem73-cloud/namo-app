/* QMES Stage 12 operational loader v55
 ...
 * NAMO-specific new Sales Order V4 owns new-order entry.
 * Enterprise Sales V2 replaces the visible Sales/Delivery list after ERP runtime.
 * Sales polish aligns table rows and forces every visible new-order action to V4.
 */
(function(){
  const STYLE_DEFS=[
