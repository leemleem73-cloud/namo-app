/* QMES Stage 12 operational loader v79
 ...
 * Live Production MRP V5: product alias and completed-work-order reconciliation.
 * Current NAMO product: 절연슬러리(NBA20-HM01).
 */
(function(){
  "use strict";
  if(window.__QMES_STAGE12_RUNTIME_V79__) return;
  window.__QMES_STAGE12_RUNTIME_V79__=true;
  ...
  const files=[
    "./js/qmes-erp-direct-navigation-hotfix-20260901-v1.js?v=20260901-directnav1",
    ...
    "./js/qmes-sales-new-order-step-navigation-hotfix-20260901-v13.js?v=20260901-stepnav1",
    ...
    "./js/workorder-status-save-align-20260824.js?v=20260907-workorder-fit1",
    "./js/qmes-workorder-status-unified-hotfix-20260901-v1.js?v=20260901-statusunified1",
    "./js/workorder-management-actions-layout-fix-20260824.js?v=20260907-workorder-fit1",
