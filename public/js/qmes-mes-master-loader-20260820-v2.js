/* QMES Stage 12 operational loader v46
 * Current modules remain loaded, but Field Input returns to the confirmed 10:08 ownership model:
 * shared shell stays active while page-content themes are isolated on POP.
 */
(function(){
  const STYLE_DEFS=[
