                ...
                <tr key={r.id} className="border-b border-slate-800/60 hover:bg-slate-800/30">
                  ...
                  <td className="py-2.5 px-2 text-center whitespace-nowrap">
                    <div className="qmes-pqc-actions" style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",width:"100%",whiteSpace:"nowrap",overflow:"visible"}}>
                      <button onClick={() => setViewingRecord(r)} title="성적서 미리보기 및 출력" className="qmes-iqc-action-btn qmes-iqc-action-print qmes-unified-inspection-action">{isOqc && <Printer size={12} />} 출력</button>
