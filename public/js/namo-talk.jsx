...
function NamoSticker({sticker,width=70,withLabel=true}){
  ...
  return <span role="img" aria-label={sticker.label} style={{width,height,display:"inline-block",flex:`0 0 ${width}px`,backgroundImage:`url(${NAMO_STICKER_SHEET})`,backgroundRepeat:"no-repeat",backgroundSize:`${720*scale}px ${1620*scale}px`,backgroundPosition:`${-sticker.x*scale}px ${-sticker.y*scale}px`,filter:"brightness(1.12) saturate(1.24) contrast(1.08)"}}/>;
}
