/* QMES field input quantity steppers — unified 54px UI for IQC/OQC. */
(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      .qmes-ipad-unified-step-field > .qmes-ipad-number-stepper { display:none!important; }
      .qmes-ipad-unified-step-field > .qmes-ipad-ship-stepper { display:none!important; }
      .${CLASS} {
      ...
      .${CLASS} > span {
        display:grid!important;grid-template-rows:1fr 1fr!important;border-left:1px solid #cbd5e1!important;
      }
      .${CLASS} button {
      ...
      .${CLASS} button:hover,.${CLASS} button:focus-visible {
        background:#e2e8f0!important;color:#0f172a!important;outline:none!important;
      }
  ...
  function enhanceLabel(label) {
    ...
    } else if (typeof box.__qmesSyncValue === 'function') {
      box.__qmesSyncValue();
    }
  }
