  ...
  return (
    <div className="space-y-5">
      ...
      {showForm && <div className="rounded-xl border border-cyan-500/40 bg-slate-900 p-4">
        ...
        {activeType === "customer" ? <div className="grid max-w-[680px] gap-2 md:grid-cols-[360px_140px_120px]">
        ...
        </div> : <div className="grid max-w-[1080px] gap-2 md:grid-cols-[230px_190px_240px_140px_120px]">
