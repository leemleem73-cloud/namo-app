      ...
      >
        ...
        <div style={{ textAlign: "center", marginTop: 10 }}>
          <a
            ...
            style={{ color: "#0f5d8f", fontSize: 13, fontWeight: 700, textDecoration: "none" }}
          >
            🌐 나모케미칼 홈페이지
          </a>
        </div>
...
function QMESApp() {
  ...
  if (checkingSession) {
    return <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#07162b",color:"white",fontWeight:800}}>로그인 상태 확인 중...</div>;
  }
