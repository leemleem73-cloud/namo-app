/* QMES Sales/Delivery integrated dashboard V1 - 2026-09-22
 * ADD-ONLY new React owner.
 * Existing Sales components remain untouched; this component becomes the visible owner
 * before the existing component lock runs.
 */
(function(){
  "use strict";
  if(window.__QMES_SALES_DELIVERY_DASHBOARD_20260922_V1__) return;
  window.__QMES_SALES_DELIVERY_DASHBOARD_20260922_V1__=true;
  ...
  function SalesDeliveryDashboard(){
    ...
    const data=useMemo(()=>buildRows(rows,inventory),[rows,inventory]);
    ...
    return h("div",{className:"qmes-sales-ledger-v4 qmes-sales-delivery-dashboard-v1"},
      h("div",{className:"qslv4-head"},
        h("div",null,
          h("h1",{className:"qslv4-title"},"수주·납기 관리대장"),
          h("div",{className:"qslv4-sub"},"수주 → 생산 → 검사 → 출하 → 납기 통합 현황")
        ),
      ...
      h("div",{className:"qsd-kpis"},
        ...
        h(Kpi,{label:"OTIF",value:otif,sub:"정시·정량 출하율",tone:"good"})
      ),
