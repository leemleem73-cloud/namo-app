...
(function(){
  "use strict";
  if(window.__QMES_SALES_LAYOUT_STABILITY_20260921_V2__) return;
  window.__QMES_SALES_LAYOUT_STABILITY_20260921_V2__=true;
  ...
  function boot(){
    ...
    /* Do not touch global sidebar/main sizing on route changes.
     * The same <main> shell persists; re-applying width/margin on every menu
     * click caused the whole work area to flash/reflow. New Sales roots are
     * already handled by the MutationObserver above. */
