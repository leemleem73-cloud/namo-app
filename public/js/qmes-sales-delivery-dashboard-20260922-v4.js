/* QMES Sales/Delivery integrated dashboard V4 - DUE/WORKDATE/SHIPDATE AUTO LINK - 2026-09-22
...
(function(){
  "use strict";
  if(window.__QMES_SALES_DELIVERY_DASHBOARD_20260922_V4__) return;
  window.__QMES_SALES_DELIVERY_DASHBOARD_20260922_V4__=true;
  ...
  function buildRows(rows,inventory,processRows){
    ...
    return (Array.isArray(rows)?rows:[]).filter(r=>r&&!isDeleted(r,m)).map(r=>{
      ...
      const out={
        ...
        shipQty:(()=>{const q=num(ship&&(ship.qty!=null?ship.qty:ship.quantity));return q==null&&shipmentDone?quantity:q})()
      };
