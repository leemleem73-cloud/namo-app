(function(){
  "use strict";
  if(window.__QMES_SYNC_SIDEBAR_V11__) return;
  window.__QMES_SYNC_SIDEBAR_V11__=true;
  ...
  const style=document.createElement('style');style.id='qmes-sync-sidebar-style';style.textContent=`
    ...
    #qmes-sync-sidebar .qmes-side-head{position:relative!important;display:flex!important;align-items:center!important;justify-content:space-between!important;min-height:48px!important;padding:8px 18px 8px 24px!important;margin:0 -10px 8px!important;background:#486482!important;box-sizing:border-box!important}
    #qmes-sync-sidebar .qmes-side-head.is-group-active{background:#e4efff!important}#qmes-sync-sidebar .qmes-side-head.is-group-active:before{content:''!important;position:absolute!important;left:0!important;top:9px!important;bottom:9px!important;width:4px!important;background:#2563eb!important}
    #qmes-sync-sidebar .qmes-side-title{font-size:14px!important;font-weight:800!important;color:#fff!important;line-height:20px!important}#qmes-sync-sidebar .qmes-side-head.is-group-active .qmes-side-title{color:#175cd3!important}
    #qmes-sync-sidebar .qmes-side-close{width:28px!important;height:28px!important;border:0!important;border-radius:6px!important;background:transparent!important;color:#e2e8f0!important;font-size:19px!important;cursor:pointer!important}#qmes-sync-sidebar .qmes-side-head.is-group-active .qmes-side-close{color:#64748b!important}
  ...
  let currentGroup='',activeLabel='',groupHighlight=false,internal=false;const head=()=>side.querySelector('.qmes-side-head');
