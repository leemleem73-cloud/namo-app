(function(){
  ...
  const isCommercialRestrictedItem=item=>item?.tab==='erpSales'||item?.tab==='erpPurchase';
  const canAccessItem=item=>!isCommercialRestrictedItem(item)||canAccessCommercialErp();
