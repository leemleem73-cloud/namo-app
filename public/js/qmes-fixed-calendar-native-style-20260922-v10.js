/* QMES FIXED CALENDAR - NATIVE STYLE V10 ULTRA MINI MOVE RESIZE RESTORE - 2026-09-22
...
(function(){
  "use strict";
  if(window.__QMES_FIXED_CALENDAR_NATIVE_STYLE_20260922_V10__) return;
  window.__QMES_FIXED_CALENDAR_NATIVE_STYLE_20260922_V10__=true;

  const POP_ID="qmes-fixed-calendar-native-style-20260922-v2-pop";
  const STYLE_ID="qmes-fixed-calendar-native-style-20260922-v10-style";
  const OLD_POP_IDS=[
  ...
  let mode="days";
  let yearPageStart=0;
  const WINDOW_KEY="qmes-sales-calendar-window-v10";
  ...
  function ensureStyle(){
    ...
    mini.id="qmes-fixed-calendar-mini-v10-style";
    mini.textContent=`
    ...
    extraMini.id="qmes-fixed-calendar-extra-mini-v10-style";
    ...
    const ultraMini=document.createElement("style");
    ultraMini.id="qmes-fixed-calendar-ultra-mini-v10-style";
    ultraMini.textContent=`
      #${POP_ID}{width:165px!important;min-width:165px!important;max-width:165px!important}
      #${POP_ID} .qnv-head{height:27px!important;grid-template-columns:1fr 21px 21px!important;padding:0 3px 0 18px!important}
      #${POP_ID} .qnv-title{height:21px!important;font-size:8px!important}
      #${POP_ID} .qnv-nav{width:21px!important;height:21px!important;font-size:15px!important}
      #${POP_ID} .qnv-move-handle{width:13px!important;height:23px!important;font-size:9px!important}
      #${POP_ID} .qnv-week{height:19px!important;padding:0 3px!important}
      #${POP_ID} .qnv-week span{font-size:8px!important}
      #${POP_ID} .qnv-grid{grid-auto-rows:19px!important;padding:0 3px 2px!important}
      #${POP_ID} .qnv-day{width:17px!important;height:17px!important;font-size:8px!important}
      #${POP_ID} .qnv-years{max-height:145px!important}
      #${POP_ID} .qnv-year-current{height:21px!important;padding:0 9px!important;font-size:8px!important}
      #${POP_ID} .qnv-month-grid{padding:2px 4px 3px!important}
      #${POP_ID} .qnv-month{height:20px!important;font-size:8px!important}
      #${POP_ID} .qnv-year{height:20px!important;padding:0 9px!important;font-size:8px!important}
      #${POP_ID} .qnv-foot{height:27px!important;padding:0 6px!important}
      #${POP_ID} .qnv-action{height:21px!important;font-size:8px!important}
      #${POP_ID} .qnv-resize-handle{width:14px!important;height:14px!important}
    `;
    document.head.appendChild(ultraMini);
