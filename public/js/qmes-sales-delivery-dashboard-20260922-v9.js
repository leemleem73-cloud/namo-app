/* QMES Sales/Delivery integrated dashboard V9 - DELETE ACTION ONLY - 2026-09-22
...
(function(){
  "use strict";
  if(window.__QMES_SALES_DELIVERY_DASHBOARD_20260922_V9__) return;
  window.__QMES_SALES_DELIVERY_DASHBOARD_20260922_V9__=true;
  ...
  function SalesDeliveryDashboard(){
    ...
    const body=shown.length?shown.map((x,i)=>h("tr",{key:x.id},
      ...
      h("td",null,h("span",{className:"qrl-actions"},
        ...
        h("button",{type:"button",className:"qrl-delete-btn",onClick:()=>deleteOrder(x)},"삭제")
      ))
