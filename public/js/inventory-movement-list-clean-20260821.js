/* Inventory table alignment v14: consistent headers and row fields across inventory sections. */
(function(){
  'use strict';
  if(window.__QMES_INV_TABLE_ALIGNMENT_V14_20260824__)return;
  window.__QMES_INV_TABLE_ALIGNMENT_V14_20260824__=true;
  ...
  function ensureStyle(){
    let style=document.getElementById('qmes-inv-table-alignment-style-v14');
    if(style)return;
    style=document.createElement('style');
    style.id='qmes-inv-table-alignment-style-v14';
    style.textContent=`
