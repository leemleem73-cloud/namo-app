/* Inventory table alignment v13: consistent headers and row fields across inventory sections. */
(function(){
  'use strict';
  if(window.__QMES_INV_TABLE_ALIGNMENT_V13_20260824__)return;
  window.__QMES_INV_TABLE_ALIGNMENT_V13_20260824__=true;
  ...
  function ensureStyle(){
    let style=document.getElementById('qmes-inv-table-alignment-style-v13');
    if(style)return;
    style=document.createElement('style');
    style.id='qmes-inv-table-alignment-style-v13';
    style.textContent=`
      #qmes-inventory-host .inv-movement-panel{padding-left:14px!important;padding-right:14px!important;overflow-x:hidden!important}
      ...
      #qmes-inventory-host .inv-movement-table thead th{height:42px!important;padding:8px 18px 8px 6px!important;line-height:1.3!important;letter-spacing:0!important;vertical-align:middle!important;border-bottom:1px solid #cbd5e1!important}
      #qmes-inventory-host .inv-movement-table tbody td{height:44px!important;padding:8px 18px 8px 6px!important;line-height:1.3!important;letter-spacing:0!important;vertical-align:middle!important;border-bottom:1px solid #e2e8f0!important}
