...
(function(global){
  ...
  // The summary is rendered by React in inventory-final-validation-ui.
  // Direct DOM insertion here caused React to remove and reinsert the panel repeatedly.
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',ensureStyle,{once:true});else ensureStyle();
  console.info('[QMES] 재고관리 MES 결과 UI v3 스타일 준비');
})(window);
