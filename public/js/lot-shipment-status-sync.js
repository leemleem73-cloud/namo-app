(function(){
  ...
  if(!document.querySelector('script[data-qmes-lot-detail-alignment-20260805]')){
    const script=document.createElement("script");
    script.src="./js/lot-detail-alignment-20260805.js?v=20260806-31";
    script.async=false;
  ...
  if(!document.querySelector('script[data-qmes-collapsible-side-menu]')){
    const script=document.createElement("script");
    script.src="./js/qmes-collapsible-side-menu.js?v=20260806-6";
    script.async=false;
  ...
  if(!document.querySelector('script[data-qmes-equipment-complaint-summary-refinement-20260805]')){
    const script=document.createElement("script");
    script.src="./js/equipment-complaint-summary-refinement-20260805.js?v=20260806-12";
    script.async=false;
    script.dataset.qmesEquipmentComplaintSummaryRefinement20260805="true";
    document.head.appendChild(script);
  }
  if(!document.querySelector('script[data-qmes-partner-equipment-action-fix]')){
    const script=document.createElement("script");
    script.src="./js/partner-equipment-action-fix-20260806.js?v=20260806-1";
    script.async=false;
    script.dataset.qmesPartnerEquipmentActionFix="true";
    document.head.appendChild(script);
  }
})();
