(function(){
  ...
  if(!document.querySelector('script[data-qmes-lot-detail-alignment-20260805]')){
    const script=document.createElement("script");
    script.src="./js/lot-detail-alignment-20260805.js?v=20260805-4";
    script.async=false;
  ...
  if(!document.querySelector('script[data-qmes-table-equipment-spacing-20260805]')){
    const script=document.createElement("script");
    script.src="./js/table-and-equipment-spacing-20260805.js?v=20260805-8";
    script.async=false;
  ...
  if(!document.querySelector('script[data-qmes-partner-equipment-fix-20260805]')){
    const script=document.createElement("script");
    script.src="./js/partner-equipment-fix-20260805.js?v=20260805-3";
    script.async=false;
