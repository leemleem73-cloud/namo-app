...
(function(){
  ...
  async function printQr(sheet,button){
    ...
    try{
      ...
      let style=document.getElementById('qmes-stable-print-style');if(!style){style=document.createElement('style');style.id='qmes-stable-print-style';document.head.appendChild(style);}style.textContent=`#qmes-stable-print-root{display:none}@media print{@page{size:A4 landscape;margin:0}html,body{margin:0!important;padding:0!important;width:297mm!important;height:210mm!important}body>*:not(#qmes-stable-print-root){display:none!important}#qmes-stable-print-root{display:flex!important;width:297mm!important;height:210mm!important;align-items:center!important;justify-content:center!important}.qmes-stable-label{width:120mm;height:80mm;padding:4mm;box-sizing:border-box;font-family:Arial,'Noto Sans KR',sans-serif;color:#111827}.qmes-stable-label .top{display:flex;justify-content:space-between;border-bottom:.4mm solid #111827;padding-bottom:2mm;font-size:14px}.qmes-stable-label .body{display:grid;grid-template-columns:1fr 48mm;gap:3mm;height:62mm;padding-top:2mm}.qmes-stable-label .meta{display:flex;flex-direction:column;justify-content:center;min-width:0}.qmes-stable-label small{font-size:9px;color:#64748b;font-weight:700;margin-top:1mm}.qmes-stable-label strong{font-size:14px;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.qmes-stable-label img{width:48mm;height:48mm;object-fit:contain;align-self:center}}`;
