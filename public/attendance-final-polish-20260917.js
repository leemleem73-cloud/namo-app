...
const IN_SRC='/attendance-card-clockin-20260917.svg?v=20260917-kakao1';
const OUT_SRC='/attendance-card-clockout-20260917.svg?v=20260917-kakao1';
...
function injectStyle(){
  ...
  style.textContent=`
html[data-namo-attendance-full-ui="v4"] body{background:#f2f3f5!important;color:#191919!important}
html[data-namo-attendance-full-ui="v4"] .app-shell{background:#f5f6f7!important}
html[data-namo-attendance-full-ui="v4"] .safe-top{background:#fee500!important}
html[data-namo-attendance-full-ui="v4"] .topbar{padding:0 12px!important;min-height:0!important;background:#fee500!important;border:0!important;border-bottom:1px solid rgba(0,0,0,.05)!important;box-shadow:0 3px 12px rgba(0,0,0,.06)!important}
...
html[data-namo-attendance-full-ui="v4"] .brand{gap:8px!important;justify-self:center!important;justify-content:center!important;max-width:300px!important;overflow:visible!important}
...
html[data-namo-attendance-full-ui="v4"] .brand-copy b{display:block!important;font-size:23px!important;line-height:1!important;letter-spacing:-.9px!important;color:#191919!important;font-weight:950!important;white-space:nowrap!important}
html[data-namo-attendance-full-ui="v4"] .brand-copy small{display:none!important}
html[data-namo-attendance-full-ui="v4"] #namoMenuBtn,html[data-namo-attendance-full-ui="v4"] #namoRefreshBtn{width:36px!important;height:36px!important;border-radius:12px!important;background:rgba(255,255,255,.42)!important;color:#191919!important;font-size:25px!important;font-weight:900!important}
html[data-namo-attendance-full-ui="v4"] .page[data-page="home"]{background:#f5f6f7!important;padding-top:0!important}
html[data-namo-attendance-full-ui="v4"] .namo-panel-title{display:grid!important;grid-template-columns:minmax(0,1fr) auto!important;align-items:center!important;column-gap:14px!important;margin:0 -14px 14px!important;padding:20px 20px!important;min-height:96px!important;background:#fff!important;border-bottom:1px solid #ececec!important;overflow:hidden!important}
...
html[data-namo-attendance-full-ui="v4"] .namo-greet-name{font-size:16px!important;font-weight:700!important;letter-spacing:-.35px!important;color:#6f6f6f!important}
html[data-namo-attendance-full-ui="v4"] .namo-greet-main{font-size:24px!important;font-weight:950!important;letter-spacing:-1px!important;color:#191919!important;white-space:nowrap!important}
html[data-namo-attendance-full-ui="v4"] #namoTodayDate{display:flex!important;align-items:center!important;justify-content:flex-end!important;width:130px!important;min-width:130px!important;padding:0!important;border:0!important;color:#191919!important;white-space:normal!important;font-variant-numeric:tabular-nums!important}
...
html[data-namo-attendance-full-ui="v4"] .namo-date-day{font-size:10.5px!important;font-weight:750!important;color:#8b8b8b!important;white-space:nowrap!important}
html[data-namo-attendance-full-ui="v4"] .namo-digital-clock{display:block!important;background:transparent!important;border:0!important;box-shadow:none!important;color:#191919!important;font-size:23px!important;line-height:1!important;font-weight:950!important;letter-spacing:-.4px!important;padding:0!important;min-width:0!important;height:auto!important}
html[data-namo-attendance-full-ui="v4"] .namo-today-card{border:0!important;border-radius:20px!important;background:#fff!important;box-shadow:0 2px 12px rgba(0,0,0,.045)!important}
html[data-namo-attendance-full-ui="v4"] .namo-today-meta b{color:#191919!important;font-size:18px!important}
html[data-namo-attendance-full-ui="v4"] #namoScheduleEdit{background:#fff7b0!important;border:0!important;color:#5b4b00!important;border-radius:9px!important;font-weight:900!important}
html[data-namo-attendance-full-ui="v4"] .namo-availability{background:#fee500!important;color:#191919!important;border-radius:10px!important;font-weight:900!important}
html[data-namo-attendance-full-ui="v4"] .namo-request-mini{border:1px solid #e3e3e3!important;border-radius:14px!important;background:#fff!important;color:#333!important;box-shadow:none!important}
html[data-namo-attendance-full-ui="v4"] .clock-btn{position:relative!important;overflow:hidden!important;background:#fff!important;background-image:none!important;border:0!important;border-radius:16px!important;outline:0!important;box-shadow:none!important;transform:none!important;filter:none!important;isolation:isolate!important}
...
html[data-namo-attendance-full-ui="v4"] .progress{height:7px!important;border-radius:999px!important;background:#ececec!important;overflow:hidden!important}
html[data-namo-attendance-full-ui="v4"] .progress span,html[data-namo-attendance-full-ui="v4"] #workProgress{width:var(--namo-stable-progress,0%)!important;background:#fee500!important;border-radius:999px!important;transition:none!important;animation:none!important;will-change:auto!important}
html[data-namo-attendance-full-ui="v4"] .progress-labels{font-size:10px!important;color:#999!important;font-variant-numeric:tabular-nums!important}
html[data-namo-attendance-full-ui="v4"] .place-card{border:1px solid #ededed!important;border-radius:16px!important;background:#fff!important;box-shadow:none!important}
html[data-namo-attendance-full-ui="v4"] .place-card .place-icon{background:#fff8bd!important;color:#6d5900!important}
html[data-namo-attendance-full-ui="v4"] .bottom-nav .nav-btn.active{color:#191919!important}
html[data-namo-attendance-full-ui="v4"] .bottom-nav .nav-btn.active .ni:after,html[data-namo-attendance-full-ui="v4"] .bottom-nav .nav-btn.active .ni:before{border-color:#191919!important}
