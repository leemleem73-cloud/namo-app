...
try{
  ...
  if(fs.existsSync(file)){
    ...
    html=html.replace('</head>','<link rel="stylesheet" href="/attendance-mobile-stability-20260908.css?v=20260908-stable2"><link rel="stylesheet" href="/attendance-reference-ui-20260908.css?v=20260908-ref2"><link rel="stylesheet" href="/attendance-admin-test-fix-20260909.css?v=20260909-kakao-admin1"><link rel="stylesheet" href="/attendance-test-ui-20260909-v1.css?v=20260909-test-ui1"></head>');
    ...
    html=html.replace('</body>','<script src="/attendance-admin-benchmark-20260909.js?v=20260909-kakao-admin1"></script><script src="/attendance-reference-ui-20260908.js?v=20260908-ref2"></script></body>');
    fs.writeFileSync(file,html,'utf8');
    console.log('[Attendance stability] TEST branch blue UI + brand + no member-flash boot guard installed');
  }
