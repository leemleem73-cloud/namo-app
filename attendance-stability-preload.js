...
try{
  ...
  if(fs.existsSync(file)){
    ...
    html=html.replace(/<script src="\/attendance-admin-mode-v4\.js\?v=[^"]+"><\/script>/g,'<script src="/attendance-admin-mode-v4.js?v=20260909-admin-fix3"></script>');
    html=html.replace('</head>','<link rel="stylesheet" href="/attendance-mobile-stability-20260908.css?v=20260908-stable2"><link rel="stylesheet" href="/attendance-reference-ui-20260908.css?v=20260908-ref2"><link rel="stylesheet" href="/attendance-admin-test-fix-20260909.css?v=20260909-admin-fix3"></head>');
    ...
    html=html.replace('</body>','<script>window.__NAMO_ATT_BOOT_FAILSAFE__=setTimeout(function(){try{delete document.documentElement.dataset.attendanceBoot}catch(e){}},3500);</script><script src="/attendance-reference-ui-20260908.js?v=20260908-ref2"></script></body>');
