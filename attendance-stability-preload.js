...
try{
  ...
  if(fs.existsSync(file)){
    ...
    html=html.replace(/<script src="\/attendance-admin-mode-v4\.js\?v=[^"]+"><\/script>/g,'<script src="/attendance-admin-mode-v4.js?v=20260909-production1"></script>');
    ...
    const styles=[
      ...
      '<link rel="stylesheet" href="/attendance-admin-test-fix-20260909.css?v=20260909-production1">',
      '<link rel="stylesheet" href="/attendance-test-ui-20260909-v1.css?v=20260909-production1">',
      '<link rel="stylesheet" href="/attendance-layout-fix-20260909.css?v=20260909-production1">',
      '<link rel="stylesheet" href="/attendance-enterprise-home-20260909.css?v=20260909-production1">'
    ].join('');
    html=html.replace('</head>',styles+'</head>');

    html=html.replace(
      '<script src="/attendance-v4-live.js',
      '<script src="/attendance-dom-compat-20260908.js?v=20260908-dom2"></script><script src="/attendance-test-fixes-20260909.js?v=20260909-production1"></script><script src="/attendance-v4-live.js'
    );

    const tail=[
      '<script src="/attendance-admin-benchmark-20260909.js?v=20260909-production1"></script>',
      '<script src="/attendance-reference-ui-20260908.js?v=20260908-ref2"></script>',
      '<script src="/attendance-enterprise-home-20260909.js?v=20260909-production1"></script>'
    ].join('');
    html=html.replace('</body>',tail+'</body>');

    fs.writeFileSync(file,html,'utf8');
    console.log('[Attendance stability] production attendance UI + admin boot guard + GPS layout installed');
  }
